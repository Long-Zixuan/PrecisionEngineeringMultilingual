...
namespace PrecisionEngineering
{
    public class Mod : IUserMod
    {
        public string Name
        {
            get { return "Precision Engineering Simple and Traditional Chinese"; }
        }
        ...
        public string Description
        {
            ...
            {
                return
                    PrecisionEngineering.Data.Language.Language.Instance.trans("Build with precision. Hold CTRL to enable angle snapping, SHIFT to show more information, ALT to snap to guide-lines.");
            }
        }
